import { 
  ...
  Play, Volume2, ShieldCheck, MapPin
} from 'lucide-react';
...
const LandingPage = () => {
  ...
  const stats = [
    { number: '70%', label: 'OpEx Reduction' },
    { number: '24/7', label: 'Voice Availability' },
    { number: '10x', label: 'Follow-up Speed' },
    { number: '99%', label: 'Accuracy Rate' }
  ];

  const automationUseCases = [
    {
      title: 'Voice AI Follow-ups',
      description: 'Human-like AI agents that call leads, handle objections, and book meetings directly into your CRM.',
      benefit: '300% increase in lead response',
      icon: Phone,
      color: 'blue'
    },
    {
    ...
    },
    {
      ...
      description: 'Analyze customer replies to categorize "Promise to Pay", "Reschedule", or "Escalate to Human".',
      benefit: 'Zero manual sorting needed',
      icon: Target,
      color: 'purple'
    }
  ];
  ...
  const industryVerticals = [
    {
      name: 'Solar & EPC',
      context: 'Sunruf Solar',
      features: ['Lead Qualification', 'Installation Milestones', 'Maintenance Alerts'],
      image: 'https://images.unsplash.com/photo-1508514177221-188b1cf16e9d?auto=format&fit=crop&q=80&w=400',
    },
    {
      name: 'Agri-Business',
      context: 'Jharkhand Fertilizers',
    ...
    },
    {
      name: 'Home Services',
      context: 'Oraplus',
      features: ['Technician Dispatch', 'Real-time ETA', 'Feedback Collection'],
    ...
    <div className="min-h-screen bg-white font-sans text-slate-900 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 text-sm font-medium mb-6">
                <Zap className="w-4 h-4" /> Now Powered by Voice AI 2.0
              </div>
              ...
              <p className="text-lg md:text-xl mb-10 text-slate-400 max-w-xl leading-relaxed">
                Automate your voice follow-ups, payment reminders, and customer service with Truemind Labs. Intelligent agents that sound human and work 24/7.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="#contact" className="bg-blue-600 hover:bg-blue-500 text-white px-8 py-4 rounded-xl font-bold text-lg transition-all shadow-lg shadow-blue-500/25 flex items-center justify-center gap-2">
              ...
              <div className="bg-slate-900/50 backdrop-blur-xl border border-slate-800 rounded-3xl p-6 shadow-2xl">
                <div className="flex items-center justify-between mb-8">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm font-mono text-slate-400">LIVE AGENT: RAHUL_AI</span>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="bg-blue-600/10 border border-blue-500/20 p-4 rounded-2xl rounded-tl-none ml-0 mr-12">
                    <p className="text-sm text-blue-100">"Hello! I'm calling from Sunruf Solar regarding your installation scheduled for tomorrow. Is 10 AM still good for you?"</p>
                  </div>
                  ...
                  <div className="bg-blue-600/10 border border-blue-500/20 p-4 rounded-2xl rounded-tl-none ml-0 mr-12">
                    <p className="text-sm text-blue-100">"Of course. I've updated the technician's schedule to 2 PM. You'll receive a confirmation SMS shortly."</p>
                  </div>
                </div>
                <div className="mt-8 pt-6 border-t border-slate-800 flex justify-between items-center">
                  <div className="text-xs text-slate-500">Processing Latency: 400ms</div>
                  <div className="text-xs text-green-400 font-mono italic">Intent: Reschedule_Success</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16 text-center">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto">We don't just build AI; we run businesses with it. From Sahibganj to Kolkata, our agents power the future of industry.</p>
          </div>
      ...
      <section id="pricing" className="py-24 bg-slate-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-slate-400 mb-16">No hidden fees. Professional AI deployment for serious businesses.</p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-slate-800/50 p-8 rounded-3xl border border-slate-700 text-left">
              ...
              <div className="text-4xl font-black mb-6">₹4L <span className="text-sm font-normal text-slate-400">/one-time</span></div>
              ...
              <button className="w-full py-3 rounded-xl bg-slate-700 hover:bg-slate-600 transition-all font-bold">Get Started</button>
            </div>
            ...
            <div className="bg-blue-600 p-8 rounded-3xl text-left transform md:scale-110 shadow-2xl shadow-blue-600/20 relative">
              ...
              <div className="text-4xl font-black mb-6">₹12L <span className="text-sm font-normal text-blue-100">/one-time</span></div>
              <ul className="space-y-4 mb-8 text-blue-50">
                ...
                <li className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-white" /> Advanced CRM Sync (Hubspot/Zoho)</li>
              ...
              <button className="w-full py-3 rounded-xl bg-white text-blue-600 hover:bg-blue-50 transition-all font-bold">Claim ROI Audit</button>
            </div>

            {/* Custom Ecosystem Plan */}
            <div className="bg-slate-800/50 p-8 rounded-3xl border border-slate-700 text-left">
              <h3 className="text-xl font-bold mb-2">Custom Ecosystem</h3>
            ...
            <div>
              ...
              <div className="space-y-8">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-bold">Regional Expertise</h4>
                    <p className="text-slate-500">Based in Kolkata & Sahibganj. We understand the local market nuances of Jharkhand and West Bengal.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="w-12 h-12 rounded-full bg-blue-50 flex items-center justify-center shrink-0">
                  ...
                  <div>
                    <h4 className="font-bold">Enterprise Reliability</h4>
                    <p className="text-slate-500">99.9% Uptime SLA for critical payment and service reminders.</p>
                  </div>
                </div>
              </div>

              <div className="mt-12 p-8 bg-slate-50 rounded-3xl border border-slate-100">
                <p className="text-sm font-bold text-slate-400 uppercase tracking-widest mb-4">Direct Access</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <div className="flex gap-6">
              <a href="https://www.linkedin.com/company/truemind-labs" target="_blank" className="text-slate-400 hover:text-blue-600 transition-colors">
            ...
            <p className="text-slate-400 text-sm italic">&copy; 2026 Truemind Labs. Built in Jharkhand.</p>
          </div>
        </div>
      </footer>
